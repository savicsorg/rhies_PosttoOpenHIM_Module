...
public abstract class PatientActionListener implements SubscribableEventListener {
	...
	protected PostToOpenhimProperties coreProperties;
	
	protected PatientService patientService;
	
	private DaemonToken daemonToken;
	
	public void setCoreProperties(PostToOpenhimProperties coreProperties) {
	...
	public void onMessage(final Message message) {
		//if (coreProperties.isSyncWithDHIS2Enabled()) {
